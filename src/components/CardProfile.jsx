        ...
        <div className="card">
            ...
            <div style={{ width: '100%', height: '253px' }}>
                <picture className="picture-container">
                    <source srcSet={pictureCV} alt="profile" style={{ width: '254px', borderRadius: '50%' }} type="image/webp" />
                    <img loading='eager' src={pictureCV2} alt="profile" style={{ width: '254px', borderRadius: '50%' }} />
                </picture>
            </div>
